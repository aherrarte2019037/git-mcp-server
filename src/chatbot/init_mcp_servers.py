...
def initialize_mcp_servers(chatbot):
    ...
    try:
        ...
        print("📁 Filesystem MCP server: read file, list files, create file")
        print("📊 Git MCP server: init repository, add file, commit, git status")
        print("🔍 Git Analyzer MCP server: analyze repository, commit stats, file stats, generate report")
